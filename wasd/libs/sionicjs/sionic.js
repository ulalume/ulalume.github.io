...
import preprocessor from "./sion-preprocesser.js"
import adapter from "./sion-adapter.js"
import Pico from "./pico.min.js"

const Sionic = (mmldata) => {
    "use strict";
    ...
    var MMLCommands = adapter.concat(MMLCommands);
